<template>
	<div>
		...
		<div class="ralative z-10">
			...
			<input class="w-64 mr-6 bg-gray-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm focus:outline-none focus:outline-blue-500 focus:shadow focus:bg-gray-100" type="text" placeholder="Search...." v-model="searchTerm" id="searchTerm" @input="search" @focus="focus=true">
