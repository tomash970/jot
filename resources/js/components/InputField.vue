<template>
	<div class="relative pb-4">
				...
				<input type="text" class="pt-8 w-full text-gray-900 border-b pb-2 focus:outline-none focus:border-blue-400" :class="errorClassObject()" :id="name" :placeholder="placeholder" v-model="value" @input="updateField()">
